...
*/
function make_shirt1(sizeShirt:string="large",message:string="I love TypeScript.") {
...
function make_shirt2(sizeShirt:string="medium",message:string="nothing impossible.") {
