...
function simpleFun (width1:number,height1:number){
    console.log(`Area of rectangle by simple function = ${width1*height1}`);
}

let arrowFun = (width2:number,height2:number) => console.log(`Area of rectangle by arrow function = ${width2*height2}`);
